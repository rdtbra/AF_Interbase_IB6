...

USHORT	CVGB_gb2312_to_unicode (obj, dest_ptr, dest_len, src_ptr, src_len, err_code, err_position)
CSCONVERT	obj;
USHORT		*dest_ptr;
USHORT		dest_len;
UCHAR		*src_ptr;
...

USHORT CVGB_unicode_to_gb2312 (obj, gb_str, gb_len, unicode_str, unicode_len, err_code, err_position) 
CSCONVERT	obj;
UCHAR		*gb_str;
USHORT		gb_len;
USHORT		*unicode_str;
...

USHORT CVGB_gb2312_byte2short (obj, dst, dst_len, src, src_len, err_code, err_position)
    CSCONVERT	obj;
    UCHAR	*dst;
    USHORT	dst_len;
    UCHAR	*src;
