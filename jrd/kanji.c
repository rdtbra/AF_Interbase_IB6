...
while (sjis_len --)
    ...
    if (*sjis_str & 0x80)                       /* Is it  SJIS */
        {
        if SJIS1((c1 = *sjis_str))              /* It is a KANJI */
            {
