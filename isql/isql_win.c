...

LRESULT CALLBACK _export ISQLWndProc(
    HWND        hWnd,
    UINT        message,
    WPARAM      wParam,
    LPARAM      lParam)
...
switch (message)
	...
	switch (GET_WM_COMMAND_ID (wParam, lParam))
		...
		SendMessage (hWnd, WM_HSCROLL,
			 	GET_WM_HSCROLL_MPS (SB_TOP, 0, 0));
		SendMessage (hWnd, WM_VSCROLL,
			 	GET_WM_VSCROLL_MPS (SB_TOP, 0, 0));
		break;
...
hWndMain = CreateWindow(
			SetUpData.appName,       /* window class name */
...
wcISQLClass.hCursor       = LoadCursor (hInstance,
					    MAKEINTRESOURCE (ISQLCURSOR));
...

BOOL CALLBACK _export blobDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export charSetDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export createDbDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export dbNameDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export dropDbDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export execDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export extractDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export objectDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export outputDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export scriptDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export sessionDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export termDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
...

BOOL CALLBACK _export transDlgProc(
    HWND        hDlg,
    UINT        iMessage,
    WPARAM      wParam,
    LPARAM      lParam)
