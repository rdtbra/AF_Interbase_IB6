...
DECLARE EXTERNAL FUNCTION trunc 
	...
	RETURNS VARCHAR (80) 
	ENTRY_POINT 'fn_trunc' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION strcat 
	VARCHAR(255), VARCHAR (255)
	RETURNS CSTRING(80) 
	ENTRY_POINT 'fn_strcat' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION doy 
	RETURNS INTEGER BY VALUE
	ENTRY_POINT 'fn_doy' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION moy 
	RETURNS SMALLINT 
	ENTRY_POINT 'fn_moy' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION dow 
	RETURNS CSTRING(12) 
	ENTRY_POINT 'fn_dow' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION sysdate 
	RETURNS CSTRING(12) 
	ENTRY_POINT 'fn_sysdate' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION fact 
	DOUBLE PRECISION	
	RETURNS DOUBLE PRECISION BY VALUE
	ENTRY_POINT 'fn_fact' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION add2 
	INTEGER,INTEGER	
	RETURNS INTEGER BY VALUE 
	ENTRY_POINT 'fn_add2' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION mul 
	DOUBLE PRECISION, DOUBLE PRECISION	
	RETURNS DOUBLE PRECISION BY VALUE 
	ENTRY_POINT 'fn_mul' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION abs
	DOUBLE PRECISION
	RETURNS DOUBLE PRECISION BY VALUE
	ENTRY_POINT 'fn_abs' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION maxnum 
	DOUBLE PRECISION, DOUBLE PRECISION
	RETURNS DOUBLE PRECISION BY VALUE
	ENTRY_POINT 'fn_max' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION sqrt 
	DOUBLE PRECISION
	RETURNS DOUBLE PRECISION
	ENTRY_POINT 'fn_sqrt' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION BLOB_BYTECOUNT
	BLOB
	RETURNS INTEGER BY VALUE
	ENTRY_POINT 'fn_blob_bytecount' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION BLOB_LINECOUNT
	BLOB
	RETURNS INTEGER BY VALUE
	ENTRY_POINT 'fn_blob_linecount' MODULE_NAME 'FUNCLIB';

DECLARE EXTERNAL FUNCTION BLOB_SUBSTR 
	BLOB, INTEGER, INTEGER 
	RETURNS CSTRING(256) 
	ENTRY_POINT 'fn_blob_substr' MODULE_NAME 'FUNCLIB';
